...
说明：无论 `REPORT_DAYS` 设多少，报告都会固定展示 `30天 / 90天 / 180天 / 1年 / 3年` 五个回看收益窗口；`REPORT_DAYS` 主要影响近期净值样本保留数量和展示长度。
...
- Top 关注清单
- 风险预警
- 汇总清单（按信号分，含 30天/90天/180天/1年/3年）
...
- 建议汇总
- 今日重点
- 基金清单（按信号分排序，含 30天/90天/180天/1年/3年）
